...
class MultistateFunctionCollectiveCanalizationMixin:
    def is_kset_canalizing(self, k: int) -> bool:
        """
        Determine whether the multistate function is k-set canalizing.
    
        A multistate function is k-set canalizing if there exists a set of ``k``
        ...
        -------
        bool
            ``True`` if the multistate function is k-set canalizing, ``False`` otherwise.
        ...
        Kadelka, C., Keilty, B., & Laubenbacher, R. (2023).
            Collectively canalizing multistate functions.
    ...
    def get_canalizing_strength(self) -> tuple:
        """
        Compute the canalizing strength of the multistate function.
        ...
        -------
        float
            Canalizing strength of the multistate function.
        ...
        if self.n==1:
            warnings.warn(
                "Canalizing strength is only defined for multistate functions with n > 1 inputs. "
                "Returning 1 for n == 1.",
                RuntimeWarning
            )
            return 1.0
    ...
    def get_input_redundancy(self) -> float:
        """
        Compute the input redundancy of the multistate function.
        ...
        Correia, R. B., Gates, A. J., Wang, X., & Rocha, L. M. (2018).
            ...
            multistate networks. *Frontiers in Physiology*, 9, 1046.
        """
        utils._require_cana()
    ...
    def get_effective_degree(self) -> float:
        """
        Compute the effective degree of the multistate function.
        ...
        -------
        float
            Effective degree of the multistate function.
